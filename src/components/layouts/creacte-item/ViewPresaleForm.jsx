            ...
            <div className="py-6 container">
                <div className="columns mt-4">
                    <div className="column is-flex-grow-2">
                        <div className="ant-card ant-card-bordered is-relative" style="overflow-x: hidden;"><div className="ant-card-body">
                            <article className="media pool-detail" style="position: relative;">
                                <div className="is-relative">
                                    <img src="/static/media/ic-bsc.419dfaf2.png" alt="BSC" style="position: absolute; bottom: 0px; right: 8px; width: 28px; z-index: 3; border: 1px solid rgba(249, 81, 146, 0.2); border-radius: 50%;" />
                                    <figure className="media-left" style="border: 1px solid rgba(249, 81, 146, 0.2); border-radius: 50%; overflow: hidden;">
                                        <div className="is-relative" style="padding: 2px;"><div>
                                            <p className="image is-48x48">
                                                <img className="is-relative" src="#" alt="" style="filter: grayscale(0); z-index: 2;" /></p>
                                        </div>
                                        </div>
                                    </figure>
                                </div>
                                        ...
                                        <div className="is-flex is-align-items-center">
                                            <div className="is-flex-grow-1 is-flex single-title">
                                                ...
                                                <div className="flex status-wrapper">
                                                    <div className="flex">
                                                        <a href="https://github.com/Coinsult/solidity/blob/main/Coinsult_Oprah_CEO_0xA3...5b6B_Audit.pdf" className="is-flex tag is-small mr-2" target="_blank" rel="noopener nofollow noreferrer" style="background-color: rgb(0, 188, 212); color: rgb(255, 255, 255);">Audit</a>
                                                    </div>
                                                    ...
                                                    <div className="flex">
                                                        <div className="mr-2">
                                                            <div className="subscription-bell is-clickable small" title="Add to favorite" style="line-height: 18px;">
                                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="10" width="10" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div>
                                                            <span className="is-flex status-dot inprogress">
                                                                ...
                                                                <span style="white-space: nowrap;">Sale Live</span></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="is-flex mt-1 mb-2">
                                            <div className="is-flex align-middle"><a href="https://oprahceo.net" rel="nofollow noreferrer" target="_blank" className="mr-4 is-size-5">
                                                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg></a><a href="https://twitter.com/oprahceo" rel="nofollow noreferrer" target="_blank" className="mr-4 is-size-5"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg></a><a href="https://t.me/OprahCEO" rel="nofollow noreferrer" target="_blank" className="mr-4 is-size-5"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M446.7 98.6l-67.6 318.8c-5.1 22.5-18.4 28.1-37.3 17.5l-103-75.9-49.7 47.8c-5.5 5.5-10.1 10.1-20.7 10.1l7.4-104.9 190.9-172.5c8.3-7.4-1.8-11.5-12.9-4.1L117.8 284 16.2 252.2c-22.1-6.9-22.5-22.1 4.6-32.7L418.2 66.4c18.4-6.9 34.5 4.1 28.5 32.2z"></path></svg></a></div></div><div className="ant-typography pool-description">Introducing Oprah CEO - the crypto meme inspired by the iconic Oprah Winfrey! 🎉💰Oprah is the new CEO in town, and she's ready to take the world by storm. 💪 With her signature enthusiasm and passion, she's offering a whopping 4% BUSD rewards to all investors who join her crypto journey. 💸💸 But that's not all - Oprah CEO promises plenty of surprises along the way! 🎁🤩From unexpected announcements to exciting developments in the world of crypto, investors can expect to be kept on their toes at all times.</div></div><div className="ant-typography"></div></div></article><div className="table-container mt-0">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td>Presale Address</td>
                                            <td className="has-text-right"><a href="#" target="_blank" rel="noreferrer nofollow"><span className="ant-typography has-text-primary">0x21e767C8FE3665894673583A46158627ee5063b6<div role="button" tabindex="0" className="ant-typography-copy" aria-label="Copy" style="border: 0px; background: transparent; padding: 0px; line-height: inherit; display: inline-block;"><span role="img" aria-label="copy" className="anticon anticon-copy"><svg viewBox="64 64 896 896" focusable="false" data-icon="copy" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M832 64H296c-4.4 0-8 3.6-8 8v56c0 4.4 3.6 8 8 8h496v688c0 4.4 3.6 8 8 8h56c4.4 0 8-3.6 8-8V96c0-17.7-14.3-32-32-32zM704 192H192c-17.7 0-32 14.3-32 32v530.7c0 8.5 3.4 16.6 9.4 22.6l173.3 173.3c2.2 2.2 4.7 4 7.4 5.5v1.9h4.2c3.5 1.3 7.2 2 11 2H704c17.7 0 32-14.3 32-32V224c0-17.7-14.3-32-32-32zM350 856.2L263.9 770H350v86.2zM664 888H414V746c0-22.1-17.9-40-40-40H232V264h432v624z"></path></svg></span></div></span></a></td></tr><tr><td>Token Name</td><td className="has-text-right">Oprah CEO</td></tr><tr><td>Token Symbol</td><td className="has-text-right">OPRAH</td></tr><tr><td>Token Decimals</td><td className="has-text-right">9</td>
                                        </tr><tr>
                                            <td>Token Address</td>
                                            <td className="has-text-right"><a className="mr-1" href="#" target="_blank" rel="noreferrer nofollow"><span className="ant-typography has-text-primary">0xA3a122766d611a96c929C99D60A2b7e622705b6B<div role="button" tabindex="0" className="ant-typography-copy" aria-label="Copy" style="border: 0px; background: transparent; padding: 0px; line-height: inherit; display: inline-block;">
                                                <span role="img" aria-label="copy" className="anticon anticon-copy"><svg viewBox="64 64 896 896" focusable="false" data-icon="copy" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M832 64H296c-4.4 0-8 3.6-8 8v56c0 4.4 3.6 8 8 8h496v688c0 4.4 3.6 8 8 8h56c4.4 0 8-3.6 8-8V96c0-17.7-14.3-32-32-32zM704 192H192c-17.7 0-32 14.3-32 32v530.7c0 8.5 3.4 16.6 9.4 22.6l173.3 173.3c2.2 2.2 4.7 4 7.4 5.5v1.9h4.2c3.5 1.3 7.2 2 11 2H704c17.7 0 32-14.3 32-32V224c0-17.7-14.3-32-32-32zM350 856.2L263.9 770H350v86.2zM664 888H414V746c0-22.1-17.9-40-40-40H232V264h432v624z"></path></svg></span>
                                            </div>
                                            </span>
                                            </a>
                                                <br />
                        ...
                        <div className="ant-card ant-card-bordered"><div className="ant-card-head">
                            ...
                            <div className="ant-card-body">
                                <div className="has-text-centered">
                                    <div style="max-width: 400px; margin: auto; height: 300px; overflow-y: hidden;">
                                        <div className="TokenMetric_root__29Tdv">
                                            <canvas height="400" width="400" data-testid="canvas" role="img" style="display: block; box-sizing: border-box; height: 400px; width: 400px;"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="LockRecord_root__31Eay">
                            <div className="ant-card ant-card-bordered">
                                ...
                                <div className="ant-card-body"><div className="ant-spin-nested-loading"><div className="ant-spin-container"><ul className="ant-list-items"><li className="ant-list-item"><div className="LockRecord_tvl__1cBpD"><strong>Amount</strong></div><div className="LockRecord_tvl__1cBpD"><strong>Unlock time(UTC)</strong></div>
                                    <div style="opacity: 0;">View</div></li></ul>
                    ...
                    <div className="column is-flex-grow-1">
                        <div className="is-relative">
                            <div className="ant-card ant-card-bordered is-relative">
                                <div className="ant-card-body">
                                    <div data-show="true" className="ant-alert ant-alert-warning ant-alert-no-icon" role="alert" style="margin-bottom: 10px;">
                                    ...
                                    <form>
                                        <div className="has-text-centered"><p className="mb-2">Presale Ends In</p>
                                            <div className="has-text-centered"><strong><span className="p-2 has-background-danger-light mr-2" style="border-radius: 4px;">02</span><span className="p-2 has-background-danger-light mr-2" style="border-radius: 4px;">10</span><span className="p-2 has-background-danger-light mr-2" style="border-radius: 4px;">35</span><span className="p-2 has-background-danger-light mr-2" style="border-radius: 4px;">13</span></strong></div></div><div className="pb-4"><div className="ant-progress ant-progress-line ant-progress-status-active ant-progress-default mt-4 mb-2">
                                                <div className="ant-progress-outer">
                                                    <div className="ant-progress-inner">
                                                        <div className="ant-progress-bg" style="width: 47.6238%; height: 15px; background: rgba(72, 199, 116, 0.5);"></div>
                                                        <div className="ant-progress-success-bg" style="width: 47.6238%; height: 15px; background-color: rgb(72, 199, 116);"></div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div style="height: 24px;"></div><div className="ant-card ant-card-bordered"><div className="ant-card-head"><div className="ant-card-head-wrapper"><div className="ant-card-head-title">Newsletters</div><div className="ant-card-extra"><label className="ant-checkbox-wrapper"><span className="ant-checkbox">
                            <input type="checkbox" className="ant-checkbox-input" value="" /><span className="ant-checkbox-inner"></span></span><span>Never show again</span></label>
                        </div>
                        </div>
                        </div>
                ...
                <div className="columns">
                    <div className="column is-flex-grow-2">
                        <div className="ant-card ant-card-bordered">
                            <div className="ant-card-body">
                                <div id="disqus_thread"><iframe id="dsq-app3518" name="dsq-app3518" allowtransparency="true" frameborder="0" scrolling="no" tabindex="0" title="Disqus" width="100%" src="#" style="width: 1px !important; min-width: 100% !important; border: none !important; overflow: hidden !important; height: 883px !important;" horizontalscrolling="no" verticalscrolling="no"></iframe><iframe id="indicator-north" name="indicator-north" allowtransparency="true" frameborder="0" scrolling="no" tabindex="0" title="Disqus" style="width: 658px !important; border: none !important; overflow: hidden !important; top: 0px !important; min-width: 658px !important; max-width: 658px !important; position: fixed !important; z-index: 2147483646 !important; height: 0px !important; min-height: 0px !important; max-height: 0px !important; display: none !important;"></iframe>
                                    <iframe id="indicator-south" name="indicator-south" allowtransparency="true" frameborder="0" scrolling="no" tabindex="0" title="Disqus" style="width: 658px !important; border: none !important; overflow: hidden !important; bottom: 0px !important; min-width: 658px !important; max-width: 658px !important; position: fixed !important; z-index: 2147483646 !important; height: 0px !important; min-height: 0px !important; max-height: 0px !important; display: none !important;">
                                    </iframe>
                                </div>
                            </div>
                        </div>
