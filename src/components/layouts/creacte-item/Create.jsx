...
//     const [rate, setPresaleRate] = useState("");
//     const [listingRate, setListingRate] = useState("");
//     const [softcap, setSoftCap] = useState("");
//     const [hardcap, setHardCap] = useState("");
//     const [minimum, setMinumum] = useState("");
//     const [maximum, setMaxumum] = useState("");
//     const [liquidity, setLiquidity] = useState("");
//     const [liquidityDate, setDateLock] = useState("");
//     const [whitelistAddress, setWhitelistUsers] = useState([]);
...
//                 handleAdd( contractAddress, rate, listingRate, softcap, hardcap,minimum, maximum,liquidity,liquidityDate, whitelistAddress,endTime,startTime);
//             }
//             catch (error) {
//                 if (whitelistAddress === '') {
