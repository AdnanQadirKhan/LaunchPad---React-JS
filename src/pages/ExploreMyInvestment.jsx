...
import PopularCollection from "../components/layouts/explore/PopularCollectionMyInvestment";
...
const Explore01 = () => {
  ...
  console.log('my presales:',list);
  useEffect(() => {
    http.get(`investment/bnb/${address}`).then((res) => setList(res.data));
  }, []);
  return (
