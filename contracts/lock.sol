...
contract LiquidityLock is ReentrancyGuard {
    ...
    function lockTokens(
        ...
        require(IERC20(_tokenAddress).transfer(address(this), _amount), "Token transfer failed");
    ...
    function changeEndTime (address _tokenAddress, uint _endTime) onlyOwner public  {
        pools[_tokenAddress].endDate = _endTime;
    }
